...
(function($) {
  ...
  Highlighters.js = Highlighters.javascript = function(code) {
    return code
      ...
      .replace(/\b(true|false|throw|return|var|if|else)\b/gm, '<span class="keyword">$1</span>');
  };
